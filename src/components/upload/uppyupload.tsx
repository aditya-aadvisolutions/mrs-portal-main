...
export default function UppyUpload(props: any) {
  let uppy: any;
  const { fileNames } = useLocation().state;
          ...
          uppy.on('files-added', (files: any) => {
            ...
            for (const prop in files) {
              ...
              if (fileNames.includes(nameWithoutExtension + extension)) {
                ...
                uppy.removeFile(file.id);  // Remove the duplicate file from Uppy
                // uppy.cancelAll();
  ...
  }, [fileNames, props.onCompleteCallback, props.filePreference, Role, uploadedFiles]);
