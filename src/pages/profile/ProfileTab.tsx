  ...
  return (
    <div className="">
        ...
        <div className="col-6 ps-0">
          <h2 className="text-2xl font-bold mb-4"><i className="fa fa-arrow-left pointer ml-1 mr-2" style={{fontSize:"26px"}} onClick={() => navigate("/employee")} aria-hidden="true"></i><strong>Profile</strong></h2>
        </div>
