...
import { removeAllUploadedFiles } from '@store/reducers/fileupload';
...
export default function Upload() {
    ...
    const handleSubmit = async (values: IUploadForm) => {
        try {
            ...
            const response = await ApiService.requests.post('Upload/SaveJob', values);
            if (response.isSuccess) {
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            {showForm && (<Form>
                                ...
                                <Button variant="secondary" type="button" onClick={() => { if (location.state) { navigate('/client-jobs') } else { setShowForm(false); dispatch(removeAllUploadedFiles()); formik.resetForm(); } }}>
                                    Cancel
                                </Button>
                            </Form>)}
                        </div>
